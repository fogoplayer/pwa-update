...
|`registrationOptions` | `registrationOptions` | A string encoding a [service worker registration options object](https://developer.mozilla.org/en-US/docs/Web/API/ServiceWorkerContainer/register#syntax). The object is parsed by JSON.parse() before being passed to `navigator.serviceWorker.register(swpath, registrationOptions)`| `string`|`"{}"`|
